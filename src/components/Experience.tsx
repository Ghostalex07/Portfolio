...
const EXPERIENCE = [
  {
    ...
    current: true,
    points: [
      "Developing backend features with Python and Java on real-world products within the engineering team.",
      "Building frontend interfaces with Angular and translating designs into responsive HTML & CSS.",
      "Working in an Agile team, running Scrum ceremonies and tracking work in Jira.",
      "Coordinating and communicating development progress with team leads and stakeholders.",
    ],
    stack: ["Python", "Java", "Angular", "Git", "Scrum"],
  },
  {
    role: "IT Specialist",
    company: "RTTC",
    ...
    points: [
      "Modernized outdated machines and updated aging hardware, improving the reliability of day-to-day operations.",
      "Provided specialized technical support and streamlined internal IT processes.",
    ],
